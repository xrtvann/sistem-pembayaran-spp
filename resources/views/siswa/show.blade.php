...
<div class="container mx-auto px-4 py-6 max-w-4xl">
    <div class="bg-white rounded-xl shadow-sm p-6 md:p-8 border border-gray-100 hover:shadow-md transition-shadow duration-300">
        ...
        <div class="mt-8 text-center">
            <a href="{{ route('siswa.index') }}" class="inline-block px-5 py-2 bg-gray-50 text-gray-700 rounded-lg border border-gray-200 hover:bg-gray-100 hover:border-gray-300 transition-colors duration-200">
